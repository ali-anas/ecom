...
from .models import Item, OrderItem, Order, Address, Customer,signup2,UserProfile,SellerAccount,Item_by_seller,SellerAccount_requested,CATEGORY,Display2,cal_cat,seller_address,SUB_CATEGORY,SUB_CATEGORY_Type,SHIPPING_MODE,ORDERS,Banner,Banner2,deals_of_the_day

# from .models import SellerAccount

admin.site.register(deals_of_the_day),
